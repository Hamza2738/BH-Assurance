...
export const content: Routes = [
  ...
  {
    path: 'application-gestion-conge/pages/home',
    loadChildren: () => import('../../application-gestion-conge/pages/home/home.module').then(m => m.HomeModule),
    data: { breadcrumb: 'Home' }
  },

  {
    path: 'application-gestion-conge/pages/gestion-demande',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-demande/gestion-demande.module').then(m => m.GestionDemandeModule),
    data: { breadcrumb: 'Demandes' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-utilisateur',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-utilisateur/gestion-utilisateur.module').then(m => m.GestionUtilisateurModule),
    data: { breadcrumb: 'Utilisateurs' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-role',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-role/gestion-role.module').then(m => m.GestionRoleModule),
    data: { breadcrumb: 'Rôles' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-grade',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-grade/gestion-grade.module').then(m => m.GestionGradeModule),
    data: { breadcrumb: 'Grades' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-user-conge',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-user-conge/gestion-user-conge.module').then(m => m.GestionUserCongeModule),
    data: { breadcrumb: 'Congés utilisateurs' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-departement',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-departement/gestion-departement.module').then(m => m.GestionDepartementModule),
    data: { breadcrumb: 'Départements' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-historique',
    loadChildren: () =>
      import('../../application-gestion-conge/pages/gestion-historique/gestion-historique.module').then(m => m.GestionHistoriqueModule),
    data: { breadcrumb: 'Historique' }
  },
  {
    path: 'application-gestion-conge/pages/gestion-type-conge',
    loadChildren: () => import('../../application-gestion-conge/pages/gestion-type-conge/gestion-type-conge.module').then(m => m.GestionTypeCongeModule),
    data: { breadcrumb: 'Types de congé' }
  },
  {
    path: 'application-gestion-conge/pages/ajout-utilisateur',
    loadChildren: () => import('../../application-gestion-conge/pages/ajout-utilisateur/ajout-utilisateur.module').then(m => m.AjoutUtilisateurModule),
    data: { breadcrumb: 'Ajout utilisateur' }
  },
  {
    path: 'application-gestion-conge/pages/ajout-demande',
    loadChildren: () => import('../../application-gestion-conge/pages/ajout-demande/ajout-demande.module').then(m => m.AjoutDemandeModule),
    data: { breadcrumb: 'Ajout demande' }
  },
